...
allButton.addEventListener('click', () => {
    webProjects.forEach(project => project.style.display = 'inline-block') // forEach help from w3schools
    ...
    comingSoon.forEach(project => project.style.display = 'none')
...
mobileButton.addEventListener('click', () => {
    ...
    mobileProjects.forEach(project => project.style.display = 'inline-block')
    miscProjects.forEach(project => project.style.display = 'none')
    comingSoon.forEach(project => project.style.display = 'inline-block')
})
